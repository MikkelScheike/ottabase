            ...
            <Stack gap="xl">
                ...
                <div>
                    ...
                    <Text size="lg" c="dimmed">
                        This demo page showcases all the available components, state management, and theme switching capabilities.
                        In a real app, you can safely delete this entire /demo directory.
                    </Text>
                ...
                <Card shadow="sm" padding="lg" radius="md" withBorder>
                    ...
                    <Text size="sm" c="dimmed" mb="lg">
                        Switch between base themes and the app's custom override to see the visual differences in components, colors, and styling.
                    </Text>
                    <ThemeSwitcher />
                </Card>
