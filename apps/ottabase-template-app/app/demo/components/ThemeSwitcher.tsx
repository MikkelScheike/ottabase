    ...
    return (
        <div>
            ...
            <Card withBorder mt="md" p="sm">
                <Text size="sm" fw={600} mb="xs">Theme Preview</Text>
                <Stack gap="xs">
                    <Group gap="xs">
                        <Button size="xs" variant="filled">Filled Button</Button>
                        <Button size="xs" variant="outline">Outline Button</Button>
                        <Button size="xs" variant="light">Light Button</Button>
                    </Group>
                    <Group gap="xs">
                        <Badge variant="filled" size="sm">Filled Badge</Badge>
                        <Badge variant="outline" size="sm">Outline Badge</Badge>
                        <Badge variant="light" size="sm">Light Badge</Badge>
                    </Group>
                </Stack>
            </Card>
        </div>
