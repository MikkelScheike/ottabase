...
const DEMO_MEDIA_ITEMS: MediaLibraryItemLike[] = [
    {
        ...
        previewUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=900',
        mimeType: 'image/jpeg',
        mediaKind: 'image',
        status: 'active',
        originalName: 'sunrise.jpg',
        title: 'Ocean Sunrise',
        caption: 'Unsplash sample image',
        fileSize: 2_450_000,
        width: 1400,
        height: 933,
    },
    {
        id: 'img-2',
        provider: 'cloudflare-images',
        storageKey: 'demo/mountains.jpg',
        url: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1400',
        thumbnailUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400',
        previewUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=900',
        mimeType: 'image/jpeg',
        mediaKind: 'image',
        status: 'active',
        originalName: 'mountains.jpg',
    ...
    },
    {
        ...
        mediaKind: 'video',
        status: 'active',
        originalName: 'flower.mp4',
        title: 'Sample Video',
        caption: 'MDN demo asset',
        fileSize: 4_380_000,
    },
];
