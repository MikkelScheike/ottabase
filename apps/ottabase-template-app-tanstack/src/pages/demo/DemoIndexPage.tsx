      ...
      <div className="mx-auto flex min-h-[calc(100vh-10rem)] max-w-4xl flex-col gap-8 px-4 py-12">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg text-muted-foreground">
            Explore different UI component libraries and features integrated
            into this template.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Full-featured demo showcasing Mantine components, theme
                switching, state management, and more
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Drag-and-drop file uploader with progress tracking, validation,
                and Cloudflare R2/Images integration
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild variant="outline" className="w-full">
                <Link to="/demo/cloudflare/file-upload">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Auto-generated CRUD forms from OttaORM model metadata. List,
                detail, create, and edit views with relationship field support.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild variant="outline" className="w-full">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Content renderer for EditorJS and HTML with custom block
                renderers and dark mode support
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild variant="outline" className="w-full">
