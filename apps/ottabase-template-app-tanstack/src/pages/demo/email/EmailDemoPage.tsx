...
const EMAIL_TYPES = [
  ...
  },
  {
    ...
    content: {
      ...
      body:
        "<p>Hey {{name}},</p>" +
        "<p>Your account is ready. You can now explore your dashboard.</p>",
  ...
  const { parsedVariables, parseError } = useMemo(() => {
    try {
      ...
      return {
        parsedVariables: {},
        parseError:
          error instanceof Error ? error.message : "Invalid JSON in variables",
      };
    }
  }, [variablesText]);
      ...
      <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Choose a template + email type and adjust the variables JSON.
            </CardDescription>
          </CardHeader>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {sendStatus.state === "error" && (
            <Badge variant="destructive">{sendStatus.message}</Badge>
          )}
