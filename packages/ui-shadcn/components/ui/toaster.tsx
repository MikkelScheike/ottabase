...
const TOAST_VARIANTS = {
  ...
  error:
    "data-[type=error]:!bg-red-50 data-[type=error]:!text-red-900 data-[type=error]:!border-red-200 dark:data-[type=error]:!bg-red-950 dark:data-[type=error]:!text-red-50 dark:data-[type=error]:!border-red-800",
  warning:
