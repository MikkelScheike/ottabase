...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform peer-data-[state=checked]:translate-x-5 peer-data-[state=unchecked]:translate-x-0",
      )}
    />
  </SwitchPrimitives.Root>
));
