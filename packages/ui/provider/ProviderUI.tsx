...
const ProviderUI = ({
	...
	const colorSchemeManager = localStorageColorSchemeManager({ key: storageKeyTheme });
	...
	return (
		<ProviderFont enforceGoogleFonts={enforceGoogleFonts}>
			...
			>
				...
				{/* Blocking overlay */}
				{(preventFOUC || preventFOUCInsideIframe) ? <div id="cdc-blocking-overlay" style={{ position: 'fixed', width: '100vw', height: '100vh', top: 0, left: 0, backgroundColor: 'rgba(255,255,255,0.98)', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Loading ...</div> : <></>}
			</MantineProvider>
		</ProviderFont>
	);
}
