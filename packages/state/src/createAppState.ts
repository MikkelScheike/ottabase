...
export function createAppState<TUser extends BaseUser = BaseUser>(
    ...
    function createAppGlobalStateAtom<K extends keyof AppGlobalState<TUser>>(key: K) {
        return atom(
    ...
    const isMobileSidebarOpenAtom = createAppGlobalStateAtom('isMobileSidebarOpen');
    const isDesktopSidebarOpenAtom = createAppGlobalStateAtom('isDesktopSidebarOpen');
