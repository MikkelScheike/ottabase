...
describe("OttaORM field/value find functionality", () => {
	...
	describe("parseCrudRequest - field/value query params", () => {
		it("should parse field and value query parameters", async () => {
			const url = new URL(
				"http://localhost/api/ottaorm/tests?field=slug&value=test-slug",
			);
		...
		it("should handle numeric value in query params", async () => {
			const url = new URL(
				"http://localhost/api/ottaorm/tests?field=id&value=123",
			);
		...
		it("should handle empty string value", async () => {
			const url = new URL(
				"http://localhost/api/ottaorm/tests?field=slug&value=",
			);
