...
export const Logo: React.FC<LogoProps> = ({
    ...
    return (
        <Flex justify="space-between" align="center" direction="row" wrap="nowrap" gap="4" style={{ minWidth: minWidthPx }}>
            <Group p="xs">
                {linkUrl ? (
                    <Link href={linkUrl} className="flex items-center gap-3">
                        {appLogoUrl && <Image src={appLogoUrl} alt={`${appNameTitle}`} h={size} w={'auto'} fit="contain" radius={4} />}
