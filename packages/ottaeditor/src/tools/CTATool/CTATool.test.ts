...
describe("CTATool", () => {
	...
	describe("Rendering", () => {
		...
		it("should update preview when text changes", () => {
			...
			const previewButton = element.querySelector(
				".cdx-cta__preview-button",
		...
		it("should update preview when style changes", () => {
			...
			expect(previewButton.classList.contains("cdx-cta__preview-button--outline")).toBe(
				true,
			);
		});
	...
	describe("Style Options", () => {
		it("should support primary style", () => {
			...
			expect(previewButton.classList.contains("cdx-cta__preview-button--primary")).toBe(
				true,
			);
		});
		...
		it("should support secondary style", () => {
			...
			expect(previewButton.classList.contains("cdx-cta__preview-button--secondary")).toBe(
				true,
			);
		});
