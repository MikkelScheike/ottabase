...
const config: StorybookConfig = {
  ...
  async webpackFinal(config) {
    ...
    const workspaceAliases: Record<string, string> = {
      ...
      '@ottabase/ui-core/styles': path.resolve(projectRoot, 'packages/ui-core/styles'),
      '@ottabase/ui-core/themes': path.resolve(projectRoot, 'packages/ui-core/themes'),
      '@ottabase/ui-core/provider': path.resolve(projectRoot, 'packages/ui-core/provider'),
      '@ottabase/ui-components': path.resolve(projectRoot, 'packages/ui-components/src'),
      '@ottabase/config': path.resolve(projectRoot, 'packages/config/src'),
      '@ottabase/state': path.resolve(projectRoot, 'packages/state/src'),
      '@ottabase/hello-world': path.resolve(projectRoot, 'packages/hello-world/src'),
      '@ottabase/ui-code-highlight': path.resolve(projectRoot, 'packages/ui-code-highlight/src'),
      '@ottabase/ui-tailwind': path.resolve(projectRoot, 'packages/ui-tailwind/src'),
      '@ottabase/ui-tailwind/styles': path.resolve(projectRoot, 'packages/ui-tailwind/styles'),
      '@ottabase/core-auth': path.resolve(projectRoot, 'packages/core-auth/src'),
      '@ottabase/core-prisma': path.resolve(projectRoot, 'packages/core-prisma/src'),
    };

    config.resolve.alias['@ottabase/ui-tailwind/styles/tailwind.base.css'] = path.resolve(projectRoot, 'packages/ui-tailwind/styles/tailwind.base.css');
